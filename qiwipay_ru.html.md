...
* Двухшаговый - операция `auth` -> операция `capture`
...
Чтобы точно понимать какой тип операции можно делать необходимо запросить статус транзакции и действовать в соответствие с [таблицей статусов](#txn_status).

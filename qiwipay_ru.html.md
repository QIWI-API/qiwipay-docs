...
###### [Редактировать на GitHub](https://github.com/QIWI-API/qiwipay-docs/blob/master/qiwipay_ru.html.md)
...
Поле | Тип | Описание
-----|-------|---------
error_code | Number | [Код ошибки](#codes)
...
8153 | Reattempt not permitted | Повторный запрос авторизации запрещен на основании правил Платежной системы.
8154 | Try again later | Повторите запрос через некоторое время.
...
8171 | Reattempt not permitted by pay system | Операция отклонена платежной системой. По данной карте повторная операция невозможна.
...
* Во всех остальных случая операция выполнится успешно.
